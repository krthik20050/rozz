...
///   2. user label whose stem (the distinctive part, e.g. "tfam") appears
///      in the key — so labeling "tfam9396@ybl" as "papa" also names
///      "tfam1967@ybl" and "tfam1967@axl" (same person, different VPAs);
...
class ResolveSenderIdentities {
  ...
  /// against the contact book — so "9811112222-2@ybl" matches the contact
  /// stored as "9811112222".
