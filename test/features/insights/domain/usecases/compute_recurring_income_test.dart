...
void main() {
  ...
  test('detects a sender who credits most months with a steady amount', () {
    final result = compute(
      transactions: [
        credit(date: '2026-03-05', amount: 2000, from: 'tfam9396@ybl'),
        credit(date: '2026-04-05', amount: 2500, from: 'tfam9396@ybl'),
        credit(date: '2026-05-05', amount: 2100, from: 'tfam9396@ybl'),
        credit(date: '2026-07-05', amount: 2200, from: 'tfam9396@ybl'),
        credit(date: '2026-08-05', amount: 2300, from: 'tfam9396@ybl'),
      ],
      labels: {'tfam9396@ybl': 'papa'},
  ...
  test('excludes senders with wildly irregular amounts (one-off windfalls)', () {
    final result = compute(
      transactions: [
        credit(date: '2026-02-05', amount: 7000, from: '9811112222-2@ybl'),
        credit(date: '2026-04-05', amount: 10500, from: '9811112222-2@ybl'),
        credit(date: '2026-06-05', amount: 5000, from: '9811112222-2@ybl'),
        credit(date: '2026-07-05', amount: 1000, from: '9811112222-2@ybl'),
      ],
      labels: const {},
      contactPhoneToName: const {},
      now: now,
  ...
  test('resolves a phone-embedded sender via the contact book', () {
    final result = compute(
      transactions: [
        credit(date: '2026-03-10', amount: 700, from: '9811112222-2@ybl'),
        credit(date: '2026-04-10', amount: 700, from: '9811112222-2@ybl'),
        credit(date: '2026-05-10', amount: 700, from: '9811112222-2@ybl'),
        credit(date: '2026-06-10', amount: 700, from: '9811112222-2@ybl'),
        credit(date: '2026-07-10', amount: 700, from: '9811112222-2@ybl'),
      ],
      labels: const {},
    ...
    expect(result.single.displayName, 'Aarav');
  });
}
