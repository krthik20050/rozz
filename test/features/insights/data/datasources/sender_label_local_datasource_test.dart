...
void main() {
  ...
  test('upsert replaces an existing label for the same key', () async {
    await datasource.upsert(const SenderLabelModel(key: 'tt9396', label: 'father'));
    await datasource.upsert(const SenderLabelModel(key: 'tt9396', label: 'dad'));
  ...
  test('getByKey returns the label or null', () async {
    ...
    final found = await datasource.getByKey('tt9396');
